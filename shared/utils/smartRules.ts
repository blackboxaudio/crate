...
const LIBRARY_FIELDS: FieldDefinition[] = [
	...
	},
	{
		...
		type: 'enum',
		enumValues: [
			{ value: 'mp3', labelKey: 'smartPlaylist.formats.mp3' },
			{ value: 'flac', labelKey: 'smartPlaylist.formats.flac' },
			{ value: 'wav', labelKey: 'smartPlaylist.formats.wav' },
			{ value: 'aiff', labelKey: 'smartPlaylist.formats.aiff' },
			{ value: 'aac', labelKey: 'smartPlaylist.formats.aac' },
			{ value: 'ogg', labelKey: 'smartPlaylist.formats.ogg' },
		],
	},
...
const DISCOVERY_FIELDS: FieldDefinition[] = [
	...
	{ field: 'notes', labelKey: 'smartPlaylist.fields.notes', type: 'text' },
	{
		...
		type: 'enum',
		enumValues: [
			{ value: 'bandcamp', labelKey: 'discovery.sources.bandcamp' },
			{ value: 'soundcloud', labelKey: 'discovery.sources.soundcloud' },
			{ value: 'youtube', labelKey: 'discovery.sources.youtube' },
			{ value: 'discogs', labelKey: 'discovery.sources.discogs' },
			{ value: 'other', labelKey: 'discovery.sources.other' },
		],
	},
