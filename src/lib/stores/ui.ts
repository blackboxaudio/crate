...
export const selectedTrackIds = derived(
  uiStore,
  ($ui) => $ui.selectedTrackIds
);

export const selectedTrackCount = derived(
  uiStore,
  ($ui) => $ui.selectedTrackIds.size
);

export const hasSelection = derived(
  uiStore,
  ($ui) => $ui.selectedTrackIds.size > 0
);
