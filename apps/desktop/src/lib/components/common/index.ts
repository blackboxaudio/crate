...
export { default as Slider } from '$shared/components/Slider.svelte'
...
export { default as DuplicateTrackModal } from './DuplicateTrackModal.svelte'
...
export { default as UpdateModal } from './UpdateModal.svelte'
