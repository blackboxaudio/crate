<script lang="ts">
	import type { DiscoveryRelease, DiscoveryTrack, ImportResultWithDuplicates } from '$shared/types'
	import { Modal, Button, Text, Checkbox, Spinner, Icon } from '$lib/components/common'
	import { discoveryStore } from '$shared/stores/discovery'
	import { transferTagsOnImport, removeReleaseAfterImport } from '$shared/stores/settings'
	import { followStore, followedSources } from '$lib/stores'
	import { translate } from '$shared/i18n'
	import { open } from '@tauri-apps/plugin-dialog'
	import { deriveArtistUrl, deriveLabelUrl, looseUrlEq, withNativeDialog } from '$shared/utils'
